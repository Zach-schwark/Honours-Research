...
for num_rows in range(1000,3000,1000):
...
with open("BDs_full_distribution_log_liklihood_list.txt", "w") as file:
    file.write(", ".join(map(str, BDs_full_distribution_log_liklihood_list)))

with open("BDs_desired_distribution_log_liklihood_list.txt", "w") as file:
