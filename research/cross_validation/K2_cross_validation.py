import sys
sys.path.insert(0,"./")
from Models import k2BayesianNetwork
...
pseudo_count = sys.argv[2]
evidence_list_type = sys.argv[3]
...
if evidence_list_type == "none":
    ...
    full_filename = "Cross_Validation_outputs/Full_Log_Likelihoods/K2_full.csv"
    ...
    desired_filename = "Cross_Validation_outputs/Desired_Log_Likelihoods/K2_desired_"+str(evidence_list_type)+".csv"
...
if full_evaluation == True:
    ...
    wandb_run_name = "K2_"+str(evidence_list_type)
