import sys
sys.path.insert(0,"./")
from Models import BDsBayesianNetwork
...
if evidence_list_type == "none":
    ...
    full_filename = "Cross_Validation_outputs/Full_Log_Likelihoods/BDs_full.csv"
    ...
    desired_filename = "Cross_Validation_outputs/Desired_Log_Likelihoods/BDs_desired_"+str(evidence_list_type)+".csv"
...
if full_evaluation == True:
    ...
    wandb_run_name = "BDs_"+str(evidence_list_type)  
